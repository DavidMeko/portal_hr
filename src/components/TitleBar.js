...
import { AppBar, Toolbar, Typography, IconButton, Box, Menu, MenuItem, Switch, FormControlLabel, Dialog, DialogContent } from '@mui/material';
...
const TitleBar = ({ onMinimize, onMaximize, onClose, darkMode, onToggleDarkMode, username, onImportData, userRole }) => {
